...
public class ThirdPersonController : MonoBehaviour
{
    ...
    void UpdateSmoothedMovementDirection()
    {
		...
		if (CrossPlatformInputManager.GetButtonDown ("Y")) {
			m_Animator.SetBool ("Punch_L",true);
			print ("ad");
		}
		if (CrossPlatformInputManager.GetButtonUp ("Y")) {
			m_Animator.SetBool ("Punch_L",false);
			print ("adjj");
	}

		if (CrossPlatformInputManager.GetButtonDown ("X")) {
			m_Animator.SetBool ("HiKick",true);
			print ("ad");
		}
		if (CrossPlatformInputManager.GetButtonUp ("X")) {
			m_Animator.SetBool ("HiKick",false);
			print ("adjj");
		}
		if (CrossPlatformInputManager.GetButtonDown ("B")) {
			m_Animator.SetBool ("LowKick",true);
			print ("ad");
		}
		if (CrossPlatformInputManager.GetButtonUp ("B")) {
			m_Animator.SetBool ("LowKick",false);
			print ("adjj");
		}
